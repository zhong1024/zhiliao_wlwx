...
//        // 登录成功后要跳转的链接
//        shiroFilterFactoryBean.setSuccessUrl("/indexArr.arr");
//        // 未授权时跳转的界面;
...
//        filterChainDefinitionMap.put("/X-admin/**", "anon");
//        filterChainDefinitionMap.put("/templates/**", "anon");
//        filterChainDefinitionMap.put("/staff/login", "anon");
//        filterChainDefinitionMap.put("/staff/index", "anon");
//        filterChainDefinitionMap.put("/role", "anon");
//        filterChainDefinitionMap.put("/index1", "authc,roles[user:add]");
//        filterChainDefinitionMap.put("/index2", "authc,roles[user:del]");
//
